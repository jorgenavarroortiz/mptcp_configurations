...
def main():
    ...
    if len(sys.argv) < 3:
        print('Too few arguments... syntax: ' + sys.argv[0] + ' <weight_if_AP1> <weight_if_AP2>')
        sys.exit()
...
#    rules = [{"src_ip":"192.168.31.2", "weight":1},{"src_ip":"192.168.32.2", "weight":5}]
    rules = [{"src_ip":"192.168.31.2", "weight":sys.argv[1]},{"src_ip":"192.168.32.2", "weight":sys.argv[2]}]
