...
def main():
    ...
    if len(sys.argv) < 3:
        print('Too few arguments... syntax: ' + sys.argv[0] + ' <weight_if_WIFI> <weight_if_5G>')
        sys.exit()
...
#    rules = [{"src_ip":"192.168.32.2", "weight":sys.argv[1]},{"src_ip":"192.168.3.2", "weight":sys.argv[2]}]
    rules = [{"dst_ip":"192.168.32.2", "weight":sys.argv[1]},{"dst_ip":"192.168.3.2", "weight":sys.argv[2]},{"dst_ip":"192.168.32.2", "weight":sys.argv[1]},{"dst_ip":"192.168.3.2", "weight":sys.argv[2]}]
