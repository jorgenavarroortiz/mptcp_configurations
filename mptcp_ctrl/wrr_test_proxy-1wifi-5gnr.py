...
#    rules = [{"dst_ip":"192.168.32.2", "weight":sys.argv[1]},{"dst_ip":"192.168.3.2", "weight":sys.argv[2]}]
    rules = [{"dst_ip":"192.168.32.2", "weight":sys.argv[1]},{"dst_ip":"192.168.3.2", "weight":sys.argv[2]},{"dst_ip":"10.1.1.2", "weight":sys.argv[1]},{"dst_ip":"10.1.1.3", "weight":sys.argv[2]}]
